...
@JsonPropertyOrder({
  GetCharactersCharacterIdBookmarksItem.JSON_PROPERTY_ITEM_ID,
  GetCharactersCharacterIdBookmarksItem.JSON_PROPERTY_TYPE_ID
})
...
public class GetCharactersCharacterIdBookmarksItem implements Serializable {
