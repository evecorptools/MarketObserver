...
@JsonPropertyOrder({
  GetUniverseTypesTypeIdDogmaAttribute.JSON_PROPERTY_ATTRIBUTE_ID,
  GetUniverseTypesTypeIdDogmaAttribute.JSON_PROPERTY_VALUE
})
...
public class GetUniverseTypesTypeIdDogmaAttribute implements Serializable {
