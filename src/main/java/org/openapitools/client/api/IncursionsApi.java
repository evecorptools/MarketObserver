...
public class IncursionsApi {
     ...
     * <p><b>200</b> - A list of incursions
     ...
     */
    public Flux<GetIncursions200Ok> getIncursions(String datasource, String ifNoneMatch) throws RestClientException {
        ...
        ParameterizedTypeReference<GetIncursions200Ok> localVarReturnType = new ParameterizedTypeReference<GetIncursions200Ok>() {};
        return apiClient.invokeFluxAPI("/incursions/", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
}
