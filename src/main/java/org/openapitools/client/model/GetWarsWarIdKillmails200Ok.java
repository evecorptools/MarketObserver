...
@JsonPropertyOrder({
  GetWarsWarIdKillmails200Ok.JSON_PROPERTY_KILLMAIL_HASH,
  GetWarsWarIdKillmails200Ok.JSON_PROPERTY_KILLMAIL_ID
})
...
public class GetWarsWarIdKillmails200Ok implements Serializable {
