...
@JsonPropertyOrder({
  GetUniverseTypesTypeIdDogmaEffect.JSON_PROPERTY_EFFECT_ID,
  GetUniverseTypesTypeIdDogmaEffect.JSON_PROPERTY_IS_DEFAULT
})
...
public class GetUniverseTypesTypeIdDogmaEffect implements Serializable {
