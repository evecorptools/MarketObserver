...
@JsonPropertyOrder({
  PutFleetsFleetIdMembersMemberIdUnprocessableEntity.JSON_PROPERTY_ERROR
})
...
public class PutFleetsFleetIdMembersMemberIdUnprocessableEntity implements Serializable {
