...
@JsonPropertyOrder({
  PostUniverseIdsInventoryType.JSON_PROPERTY_ID,
  PostUniverseIdsInventoryType.JSON_PROPERTY_NAME
})
...
public class PostUniverseIdsInventoryType implements Serializable {
