...
@JsonPropertyOrder({
  PostUniverseIdsConstellation.JSON_PROPERTY_ID,
  PostUniverseIdsConstellation.JSON_PROPERTY_NAME
})
...
public class PostUniverseIdsConstellation implements Serializable {
