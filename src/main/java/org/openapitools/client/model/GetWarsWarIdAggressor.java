...
@JsonPropertyOrder({
  GetWarsWarIdAggressor.JSON_PROPERTY_ALLIANCE_ID,
  GetWarsWarIdAggressor.JSON_PROPERTY_CORPORATION_ID,
  GetWarsWarIdAggressor.JSON_PROPERTY_ISK_DESTROYED,
  GetWarsWarIdAggressor.JSON_PROPERTY_SHIPS_KILLED
})
...
public class GetWarsWarIdAggressor implements Serializable {
