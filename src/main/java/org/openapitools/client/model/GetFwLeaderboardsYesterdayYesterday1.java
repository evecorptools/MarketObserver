...
@JsonPropertyOrder({
  GetFwLeaderboardsYesterdayYesterday1.JSON_PROPERTY_AMOUNT,
  GetFwLeaderboardsYesterdayYesterday1.JSON_PROPERTY_FACTION_ID
})
...
public class GetFwLeaderboardsYesterdayYesterday1 implements Serializable {
