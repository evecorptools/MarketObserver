...
@JsonPropertyOrder({
  GetUniverseMoonsMoonIdPosition.JSON_PROPERTY_X,
  GetUniverseMoonsMoonIdPosition.JSON_PROPERTY_Y,
  GetUniverseMoonsMoonIdPosition.JSON_PROPERTY_Z
})
...
public class GetUniverseMoonsMoonIdPosition implements Serializable {
