...
@JsonPropertyOrder({
  GetFwStatsVictoryPoints.JSON_PROPERTY_LAST_WEEK,
  GetFwStatsVictoryPoints.JSON_PROPERTY_TOTAL,
  GetFwStatsVictoryPoints.JSON_PROPERTY_YESTERDAY
})
...
public class GetFwStatsVictoryPoints implements Serializable {
