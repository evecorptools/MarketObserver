...
@JsonPropertyOrder({
  GetFwLeaderboardsLastWeekLastWeek.JSON_PROPERTY_AMOUNT,
  GetFwLeaderboardsLastWeekLastWeek.JSON_PROPERTY_FACTION_ID
})
...
public class GetFwLeaderboardsLastWeekLastWeek implements Serializable {
