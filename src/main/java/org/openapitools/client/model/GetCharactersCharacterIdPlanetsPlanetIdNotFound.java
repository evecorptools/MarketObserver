...
@JsonPropertyOrder({
  GetCharactersCharacterIdPlanetsPlanetIdNotFound.JSON_PROPERTY_ERROR
})
...
public class GetCharactersCharacterIdPlanetsPlanetIdNotFound implements Serializable {
