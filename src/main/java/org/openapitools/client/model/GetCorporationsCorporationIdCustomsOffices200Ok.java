...
@JsonPropertyOrder({
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_ALLIANCE_TAX_RATE,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_ALLOW_ACCESS_WITH_STANDINGS,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_ALLOW_ALLIANCE_ACCESS,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_BAD_STANDING_TAX_RATE,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_CORPORATION_TAX_RATE,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_EXCELLENT_STANDING_TAX_RATE,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_GOOD_STANDING_TAX_RATE,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_NEUTRAL_STANDING_TAX_RATE,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_OFFICE_ID,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_REINFORCE_EXIT_END,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_REINFORCE_EXIT_START,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_STANDING_LEVEL,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_SYSTEM_ID,
  GetCorporationsCorporationIdCustomsOffices200Ok.JSON_PROPERTY_TERRIBLE_STANDING_TAX_RATE
})
...
public class GetCorporationsCorporationIdCustomsOffices200Ok implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String JSON_PROPERTY_ALLIANCE_TAX_RATE = "alliance_tax_rate";
  private Float allianceTaxRate;

  public static final String JSON_PROPERTY_ALLOW_ACCESS_WITH_STANDINGS = "allow_access_with_standings";
  private Boolean allowAccessWithStandings;

  public static final String JSON_PROPERTY_ALLOW_ALLIANCE_ACCESS = "allow_alliance_access";
  private Boolean allowAllianceAccess;

  public static final String JSON_PROPERTY_BAD_STANDING_TAX_RATE = "bad_standing_tax_rate";
  private Float badStandingTaxRate;

  public static final String JSON_PROPERTY_CORPORATION_TAX_RATE = "corporation_tax_rate";
  private Float corporationTaxRate;

  public static final String JSON_PROPERTY_EXCELLENT_STANDING_TAX_RATE = "excellent_standing_tax_rate";
  private Float excellentStandingTaxRate;

  public static final String JSON_PROPERTY_GOOD_STANDING_TAX_RATE = "good_standing_tax_rate";
  private Float goodStandingTaxRate;

  public static final String JSON_PROPERTY_NEUTRAL_STANDING_TAX_RATE = "neutral_standing_tax_rate";
  private Float neutralStandingTaxRate;

  public static final String JSON_PROPERTY_OFFICE_ID = "office_id";
  private Long officeId;

  public static final String JSON_PROPERTY_REINFORCE_EXIT_END = "reinforce_exit_end";
  private Integer reinforceExitEnd;

  public static final String JSON_PROPERTY_REINFORCE_EXIT_START = "reinforce_exit_start";
  ...
  public static final String JSON_PROPERTY_TERRIBLE_STANDING_TAX_RATE = "terrible_standing_tax_rate";
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALLIANCE_TAX_RATE)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALLOW_ACCESS_WITH_STANDINGS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALLOW_ALLIANCE_ACCESS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BAD_STANDING_TAX_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CORPORATION_TAX_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_EXCELLENT_STANDING_TAX_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_GOOD_STANDING_TAX_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NEUTRAL_STANDING_TAX_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_OFFICE_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REINFORCE_EXIT_END)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REINFORCE_EXIT_START)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TERRIBLE_STANDING_TAX_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
