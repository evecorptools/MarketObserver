...
@JsonPropertyOrder({
  GetKillmailsKillmailIdKillmailHashUnprocessableEntity.JSON_PROPERTY_ERROR
})
...
public class GetKillmailsKillmailIdKillmailHashUnprocessableEntity implements Serializable {
