...
@JsonPropertyOrder({
  PostCharactersCharacterIdMailRecipient.JSON_PROPERTY_RECIPIENT_ID,
  PostCharactersCharacterIdMailRecipient.JSON_PROPERTY_RECIPIENT_TYPE
})
...
public class PostCharactersCharacterIdMailRecipient implements Serializable {
