...
@JsonPropertyOrder({
  GetUniverseConstellationsConstellationIdNotFound.JSON_PROPERTY_ERROR
})
...
public class GetUniverseConstellationsConstellationIdNotFound implements Serializable {
